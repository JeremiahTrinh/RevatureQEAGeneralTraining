...
def get_task_list(json_file_name):
    try:
        ...
        print(f"Warning: '{json_file_name}' not found. Starting with an empty list.")
        tasks = []
...
def add_task(task_description, task_completion):
    new_task = {
...
def mark_task(task_description):
    for task in task_list:
...
while not is_user_done:
    ...
    match user_action:
        case 1:
            ...
            add_task(task_desc, current_completion)
        case 2:
            view_tasks()
        case 3:
